...
After excluding participants with missing data from other variables a total of `r Nobs_model` complete cases were available for analysis (Table 2).
...
(HR = `r inline_text(tab_inf, variable = exposure, level = "Comfortable", column = estimate_1)`,
95% CI = `r inline_text(tab_inf, variable = exposure, level = "Comfortable", column = conf.low_1)` to `r inline_text(tab_inf, variable = exposure, level = "Comfortable", column = conf.high_1)`),
when compared to those discharged to a prosperous neighborhood.
Participants discharged to a distressed neighborhood had a much higher risk
...
tab_inf %>%
  as_kable(
    caption = "**Table 2** Effect of SES on mortality; HR estimates were adjusted for sex, race, age, substance abuse, education, employment status, urbanization, spinal cord injury, cause of injury, rehabilitation payor, residence after rehab discharge, days from injury to discharge, FIM motor and FIM cognitive at discharge."
  )
```
