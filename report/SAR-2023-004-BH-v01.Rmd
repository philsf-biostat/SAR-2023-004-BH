...
When considering only late deaths the SES effect is also not significantly associated with mortality, and estimates relative to a prosperous neighborhood range from `r range_late[1]` to `r range_late[2]` (which is an even narrower range than the crude estimates).
