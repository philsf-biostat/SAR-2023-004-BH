...
There initially were `r Nobs_orig` observations on `r Nobs_incl_id` study participants considered for inclusion.
After applying the inclusion and exclusion criteria for the study period between `r study_period[1]` and `r study_period[2]` a total of `r Nobs_final` were included in the analysis.
