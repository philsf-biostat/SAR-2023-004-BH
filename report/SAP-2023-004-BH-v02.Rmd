---
title: "Analytical Plan for Effect of socioeconomic status of neighborhoods in mortality mortality rates after brain injury: cohort study"
...
**Analytical Plan for Effect of socioeconomic status of neighborhoods in mortality mortality rates after brain injury: cohort study**

**Document version**

```{r history}
Version <- c("01", "02")
Changes <- c("Initial version", "Don't impute missing Zip codes for SES data; title + design now reflect a prospectively collected cohort study.")
...
- **SAR-2023-004-BH-v02** -- Effect of socioeconomic status of neighborhoods in mortality mortality rates after brain injury: cohort study
