...
After applying the inclusion criteria for the study period between 2010-01-01 and 2018-12-31 and considering the status at the last available follow up time for each individual a total of 7,972 participants were included in the analysis.
After excluding participants that were followed up concomitant with the COVID-19 pandemic to mitigate confounding on mortality causes there were 2,692 participants left in the study sample.
...
After excluding participants with missing data from other variables a total of 2,074 complete cases were available for analysis.
